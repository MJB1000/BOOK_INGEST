...
URL Source: http://portal.9operators.com/episodes/cmr0psblp004m04jpkm6ghck5
...
[Sponsor Content] Before Q4 hits, the smartest e-commerce operators aren't just asking, how do we spend more? They're asking, how do we make every visitor more profitable? That is where AfterSell comes in. AfterSell helps e-commerce brands increase revenue per visitor, contribution margin, and incremental profit by optimizing the highest intent moments: cart, checkout, post-purchase, and even the thank you page. Brands like Hexclad, Ridge, and Pilar increasing their AOV across every cohort using these zero-risk upsells. We've tested and they have no negative impact on conversion. It's just more free money in your pocket. And with Rocked Thanks, you can offset your AfterSell subscription. No redesigns, no risky funnels, just better economics. Wanna see how much money you can make with AfterSell? Aftersell, go to aftersell.com/rocketrevenueforecast, put in your numbers and see how much more profit your funnel will make before BFCM starts. I have no idea how else to get to, to understand the value of multiple landing pages in the account. It just ends up being like, that's why, that's why I made the argument earlier. Like, I don't feel launching multiple landing pages within the account is actually testing them at all. I can hear the argument that you're making the ad account better, and that's, I guess, how you're managing it. You're saying like, hey, performance is good, business is good, we're hitting our goals. We happen to have all these landing page testing live. Maybe I've seen some interesting stuff around, uh, CPMR.
...
[Sponsor Content] Richpanel CEO just predicted his own SaaS product will lose 90% of its revenue, and he's the one building what will kill it. They are betting that AI agents will replace traditional support tools entirely. No dashboards, no seats, no workflows. So what did they ship? An autonomous AI agent that handles customer support from end to end. Reading order data, issuing refunds, updating shipments without a human ever touching it. It means you can run a faster, leaner support team at a fraction of the cost. While resolving tickets instantly, 24/7. Richpanel is cannibalizing their own business to build the future of CX and support for brands. Because if they don't, someone else will. Go check out what they're building at richpanel.com and learn how you can automate your entire support operation today. The initial test is going to be like, let's get the two versions of the theme as like for like as possible so that we remove really some of the like random variables. And we're even like, um, You know, as we've been building out the new theme, we've continued to test new, um, strategies on our existing theme. So we found wins, like we have this cool, like bundler that's like working pretty well now. Now the bundle is not built out in the new theme. So we're even like adjusting the current theme, removing the bundler again, so that, that, so that it can be a proper A/B test against a new one. Because again, my fear is like, and it, but it makes sense though, right? Like, uh, actually an easier example is like we have this really like Um, we have this progress bar built out that conditionally triggers based on like what products you're adding to the cart so that we can do like different breakpoints by all of our different categories. And it's been like, it's kind of a hairy thing to have to deal with. We don't have it ready yet in the new theme. So we're actually just going to turn off the progress bar in the old theme. So I'm actually down to like not only merchandise a new theme as similar to, as similar to the old theme as possible, but even change the old theme to match what is capable in the new theme. Just so we can like remove as many variables as possible. So that's step one. And then what I like what you just said is we could very easily launch with the multivariate test, have a C variant that makes a few more unique decisions on top of the new theme. And then we're effectively running like a test between those, um, like concurrently as we're testing against old theme as well. So, all right, I'll keep you posted. That's, that's good feedback.

Cody Plofker

45:31

Um, yeah, I'm curious. That's likely how I do it. So, all right. And last thing I asked, are you Did you not build in the bundles in the cart just because of like timing and development and you'll plan to get them later? Or was that like an active decision? Okay.
